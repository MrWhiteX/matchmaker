...
import { IBrowseProps } from "pages/profiles/browse";
import apiRoutes from "utils/apiRoutes";

const UserFilters = ({ skills, timezones, currentUser }: IBrowseProps) => {
  const router = useRouter();

  const updateFilter = async (e: ChangeEvent<HTMLSelectElement>) => {
